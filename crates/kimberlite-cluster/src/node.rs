...
mod tests {
    ...
    fn render_cluster_peers_env_inserts_self_in_id_order_with_vsr_offset() {
        let env = render_cluster_peers_env(
            ...
            "127.0.0.1",
            5433,
            &["127.0.0.1:5432".to_string(), "127.0.0.1:5434".to_string()],
        );
        // VSR ports = data ports + VSR_PORT_OFFSET (100).
        assert_eq!(env, "0=127.0.0.1:5532,1=127.0.0.1:5533,2=127.0.0.1:5534");
    }

    #[test]
    fn render_cluster_peers_env_handles_node_zero() {
        let env = render_cluster_peers_env(0, "127.0.0.1", 5432, &["127.0.0.1:5433".to_string()]);
    ...
    fn render_cluster_client_peers_env_keeps_data_ports() {
        ...
        assert_eq!(env, "0=127.0.0.1:5432,1=127.0.0.1:5433,2=127.0.0.1:5434");
    }
